...
$(document).ready(function(){
  $.ajax(NTmuniUrl).done(function(data){
    ...
    var defaultboundary = L.geoJson(parsedData_NTmuni,
      {
        ...
        console.log("northern triangle country boundary generated.");
  })
})
